...
3. For new decks, define objectives, audience, duration, and learner output before slide structure.
4. Select the relevant module from `modules/`.
5. Preserve notation, bibliography, and diagram consistency.
6. Compile or convert.
7. Run QA when quality matters.
8. Deploy only when explicitly requested.
