...
Launch the `quarto-critic` agent to compare Beamer vs Quarto comprehensively. Report saved to `08_outputs_质量报告/[Lecture]_qa_critic_round1.md`.
...
Save to `08_outputs_质量报告/[Lecture]_qa_final.md` with hard gate status, iteration summary, and remaining issues.
